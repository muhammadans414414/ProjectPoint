class EngineeringManagers::UserProjectsController < ApplicationController
    # def new
    ...
    def create
      ...
      if @status
        if @user_project.save
          redirect_to technical_leads_projects_path
        else
          render :assigndeveloper
        end
      else
        redirect_to technical_leads_projects_path, alert: "You have already assigned this project to this developer"
      end
    end
