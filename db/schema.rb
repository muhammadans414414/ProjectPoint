...
ActiveRecord::Schema[7.0].define(version: 2022_09_19_060428) do
  ...
  create_table "lead_roles", force: :cascade do |t|
    t.bigint "role_id", null: false
    t.bigint "lead_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["lead_id"], name: "index_lead_roles_on_lead_id"
    t.index ["role_id"], name: "index_lead_roles_on_role_id"
  end
  ...
  add_foreign_key "lead_roles", "leads"
  add_foreign_key "lead_roles", "roles"
