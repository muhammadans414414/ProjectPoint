class AddColumnsToPersonalInformations < ActiveRecord::Migration[7.0]
  def change
    add_column :personal_informations, :mobile, :string, null: false
    add_column :personal_informations, :residence_phone, :string, null: false
    ...
    add_column :personal_informations, :personal_email, :string, null: false
    add_column :personal_informations, :residence_address, :text, null: false
    add_column :personal_informations, :permanent_address, :text, null: false
  end
end
